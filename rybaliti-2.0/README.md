# rybaliti-2.2 (база — rybaliti-2.0)

**Рыбалити 2.2 — Нереальное зарыбление.** Браузерная игра-рыбалка от первого
...
![Рыбалити 2.2](previews/og-image.webp)

## Скриншоты

| Главная | В игре | Мобильный |
| --- | --- | --- |
| ![Главная](screenshots/home.webp) | ![В игре](screenshots/desktop.webp) | ![Мобильный](screenshots/mobile.webp) |
...
- 28 видов рыбы (от уклейки до белуги) с уникальными процедурными превью; редкие виды клюют только на серьёзные приманки — требование видно в атласе плюс особые морские чудища (Кракен, Лесси, Посейдон, Левиафан).
- Раз в 4–6 дней — особое событие: шанс на чудище, которое удержит только крепкая снасть (карбон и выше).
...
- Мем-пасхалки proxy-комьюнити: рыбы бормочут фингерпринты (`qq`, `ff`, `hy2`, `hysteria`, `xhttp`, `naiveproxy`…), за рекой мигает придорожный мотель `MTProto · MOTEL · NO VACANCY` с неоновой стрелкой, по дневным часам из воды выглядывает ехидная мартышка.
- Прогресс и очки сохраняются в `localStorage`.


## Новое в 2.1

- 🗑️ **Мусорный пакет** — иногда клюёт хлам: 0 очков, грустные глазки, торчит рыбий скелетик. Береги природу.
- 🌊 **Рывки рыбы** — рыба от «необычной» и выше может рвануть во время вываживания: дистанция растёт, держать леску опасно. Чем реже рыба, тем чаще и дольше рывки.
- 🌟 Чудища стали реже: особое событие — раз в 4–6 дней, шанс в забросе снижен.
- 🌅 Утром рыба клюёт заметно медленнее, зато болтает фингерпринтами чаще — ждать дольше, читать веселее.
- 🐟 +6 новых видов: краснопёрка (опарыш), голавль и форель (воблер), жерех и угорь (блесна), таймень (только живец).
- 🌬️ Живой фон: два ряда ёлок качаются на ветру с порывами, камыши гнутся и дрожат, по воде бежит мелкая рябь по направлению ветра, кувшинки покачиваются.
- 🏨 Отель за рекой перестроен в классический придорожный **мотель**: два этажа, двери номеров с балконной галереей, навес на столбах, вывеска на каркасе и неоновая стрелка.

## Новое в 2.2

- 🐟 +7 новых видов: пескарь и густера (обычные), чехонь (необычная), берш и хариус (редкие), сёмга и белуга (эпические трофеи). Всего 28 видов рыбы.
- 🪱 +5 наживок с «привязкой» к рыбе: тесто, мотыль, кукуруза, мушка, виброхвост. Каждая ловит «свою» рыбу лучше, чужую — хуже или только мелкой (поля `aff`/`small` в `data.js`).
- 🎣 +3 удочки: бюджетная телескопическая, средние фидер и матчевая (плюс добавлено превью для «Нереальной»).
- 🌊 **Косяки рыбы** — на воде изредка появляется стая с одной из трёх SVG-анимаций (рябь стрелкой / рассыпание / вихрь). Заброс в косяк — клюёт чаще, быстрее и крупнее этот вид.
- 🐠 Оживление: декоративные рыбы плавают в толще воды и не реагируют на крючок, у поплавка толпится больше «болтающих» рыб, шире словарь фингерпринтов.
- 🌲 Богаче фон: разные деревья (сосны, лиственные, берёзы) и далёкий город силуэтами у горизонта с окнами, что светятся ночью.
- ⚠️ Постоянный баннер прочности удочки: висит, пока прочность ≤25%, до самой поломки.
...
rybaliti-2.0/
  ...
  previews/           og-image.webp для превью ссылок
...
мартышка автоматически подхватываются из `assets/sprites/<имя>.webp`, если файл
...
Баннер `previews/og-image.webp` (1280×640, webp) — для красивых превью ссылок в
