# rybaliti-2.1 (база — rybaliti-2.0)

**Рыбалити 2.1 — Нереальное зарыбление.** Браузерная игра-рыбалка от первого
...
![Рыбалити 2.1](previews/og-image.webp)
...
- 21 вид рыбы (от уклейки до тайменя) с уникальными процедурными превью; редкие виды клюют только на серьёзные приманки — требование видно в атласе плюс особые морские чудища (Кракен, Лесси, Посейдон, Левиафан).
...
- Мем-пасхалки proxy-комьюнити: рыбы бормочут фингерпринты (`qq`, `ff`, `hy2`, `pq`, `naiveproxy`…), за рекой мигает придорожный мотель `MTProto · MOTEL · NO VACANCY` с неоновой стрелкой, по дневным часам из воды выглядывает ехидная мартышка.
